...
public class BaseGraphServiceClient extends BaseClient implements IBaseGraphServiceClient {
	 ...
	 */
	protected BaseGraphServiceClient() {
    }
	...
	public static final class Builder<httpClientType> {
		 ...
		 */
		@Nonnull
		public IBaseGraphServiceClient buildClient() throws ClientException {
			BaseGraphServiceClient client = new BaseGraphServiceClient();
