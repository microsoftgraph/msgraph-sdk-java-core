...
public class TestChangeNotificationEncryptedContent implements DecryptableContent, AdditionalDataHolder, BackedModel, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link TestChangeNotificationEncryptedContent} and sets the default values.
     */
    public TestChangeNotificationEncryptedContent() {
     ...
     */
    @jakarta.annotation.Nonnull
    public static TestChangeNotificationEncryptedContent createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new TestChangeNotificationEncryptedContent();
    }
    /**
